<template>
  <div class="banner2 h-full w-full bg-[#2563EB] absolute top-0 left-0">
      ...
      <div class="dealer select-none font-sans font-medium rounded-[50%] border-[0.2vh] border-black border-solid bg-white h-[4%] w-[4%] text-[2vh] text-center absolute top-[86%] left-[65%] block">D</div>
      ...
      <div class="dealer select-none font-sans font-medium rounded-[50%] border-[0.2vh] border-black border-solid text-center bg-white text-[2vh] absolute rotate-90 top-[65%] left-[6%] hidden">D</div>
      <div class="smblind rounded-[50%] border-[0.2vh] border-black border-solid bg-blue-600 absolute rotate-90 top-[65%] left-[6%] select-none font-sans font-medium text-center h-[4%] w-[4%] text-[2vh] block">S</div>
      ...
      <div class="dealer select-none font-sans font-medium rounded-[50%] border-[0.2vh] border-black border-solid text-center bg-white text-[2vh]  absolute rotate-90 bottom-[65%] left-[6%] hidden">D</div>
      ...
      <div class="bigblind rounded-[50%] border-[0.2vh] border-black border-solid bg-red-600 absolute rotate-90 bottom-[65%] left-[6%] select-none font-sans font-medium text-center h-[4%] w-[4%] text-[2vh] block">B</div>
      ...
      <div class="dealer select-none font-sans font-medium rounded-[50%] border-[0.2vh] border-black border-solid text-center bg-white text-[2vh]  absolute rotate-180 bottom-[430px] left-[170px] hidden">D</div>
      ...
      <div class="dealer select-none font-sans font-medium rounded-[50%] border-[0.2vh] border-black border-solid text-center bg-white text-[2vh]  absolute -rotate-90 bottom-[65%] right-[6%] hidden">D</div>
      ...
      <div class="dealer select-none font-sans font-medium rounded-[50%] border-[0.2vh] border-black border-solid text-center bg-white text-[2vh]  absolute -rotate-90 top-[65%] right-[6%] hidden">D</div>
